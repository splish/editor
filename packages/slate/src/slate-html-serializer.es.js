...
import { Node, Value } from './slate.es'
...
var Html =
  ...
  function Html() {
    ...
    var _options$defaultBlock = options.defaultBlock,
      defaultBlock =
        _options$defaultBlock === undefined
          ? 'paragraph'
          : _options$defaultBlock,
      _options$parseHtml = options.parseHtml,
      parseHtml =
        _options$parseHtml === undefined
          ? defaultParseHtml
          : _options$parseHtml,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.deserializeElement = function(element) {
    ...
    var next = function next(elements) {
      ...
      switch (typeOf(elements)) {
        ...
        default:
          throw new Error(
            'The `next` argument was called with invalid children: "' +
              elements +
              '".'
          )
      }
    ...
    try {
      for (
        var _iterator = _this.rules[Symbol.iterator](), _step;
        ...
        if (
          ...
          throw new Error(
            'A rule returned an invalid deserialized representation: "' +
              node +
              '".'
          )
        }
  ...
  this.serializeNode = function(node) {
    ...
    try {
      for (
        var _iterator2 = _this.rules[Symbol.iterator](), _step2;
    ...
    throw new Error(
      'No serializer defined for node of type "' + node.type + '".'
    )
  }
  ...
  this.serializeLeaf = function(leaf) {
    ...
    return leaf.marks.reduce(function(children, mark) {
      ...
      try {
        for (
          var _iterator3 = _this.rules[Symbol.iterator](), _step3;
  ...
  this.serializeString = function(string) {
    ...
    try {
      for (
        var _iterator4 = _this.rules[Symbol.iterator](), _step4;
