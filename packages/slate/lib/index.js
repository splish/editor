...
var _subject = require('material-ui/svg-icons/action/subject');
...
exports.default = function () {
  ...
  var StaticComponent = function StaticComponent(_ref3) {
    ...
    return _react2.default.createElement('div', { className: 'ory-plugins-content-slate-container', dangerouslySetInnerHTML: { __html: html.serialize(editorState) } });
  };
  return {
    Component: Slate,
